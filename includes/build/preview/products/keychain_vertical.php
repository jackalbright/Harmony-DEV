...
<tr>
	...
	<td valign=top colspan=1 rowspan=1 style="background-color: white; width: <?= $imgw ?>px; height: <?= $imgh?>px; vertical-align: top; text-align: center; background-image: url('<?= $path ?>/image.png'); ">
		<? product_preview_image($image, null, $imgw, $imgh); ?>
	</td>
	<td valign=top colspan=1 rowspan=2>
		<img src="<?= $path ?>/center.png"/>
	</td>
	<td valign=top colspan=1 rowspan=2 style="background-color: white; vertical-align: center; text-align: center; background-image: url('<?= $path ?>/text.png'); ">
		<div style="height: <?=$texth?>px; width: <?=$textw?>px; padding: 2px; overflow: hidden;">
