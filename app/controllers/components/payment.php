...
class PaymentComponent extends Object
{
	...
	#	$this->config["test_paypal"];
		...
		# PUTS PAYPAL INTO TEST/SANDBOX MODE IF ON TEST SITE (anything BUT livesite)!
		$this->test_paypal = file_exists(dirname(__FILE__)."/../../config/PAYPAL_TESTMODE.TXT") || (empty($controller->livesite));
	}
