...
<?php echo $form->create('CustomImage');?>
	<fieldset>
 		<legend><?php __('Edit CustomImage');?></legend>
	<?php
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('CustomImage.Image_ID')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('CustomImage.Image_ID'))); ?></li>
