...
<h2><?php  __('CustomImage');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $this->Html->link($customImage['CustomImage']['Image_Location']); ?>
			&nbsp;
			<a href="<?= $customImage['CustomImage']['Image_Location'] ?>">
			<img width="200" src="<?= $customImage['CustomImage']['display_location'] ?>"/>
			</a>
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Display Location'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $this->Html->link($customImage['CustomImage']['display_location']); ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Thumbnail Location'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $this->Html->link($customImage['CustomImage']['thumbnail_location']); ?>
			&nbsp;
		</dd>
