...
<?php echo $form->create('SpecialtyPageProspect');?>
	<fieldset>
 		<legend><?php __('Edit SpecialtyPageProspect');?></legend>
	<?php
		echo $form->input('specialty_page_prospects_id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('SpecialtyPageProspect.specialty_page_prospects_id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('SpecialtyPageProspect.specialty_page_prospects_id'))); ?></li>
