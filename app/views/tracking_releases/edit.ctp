...
<?php echo $form->create('TrackingRelease');?>
	<fieldset>
 		<legend><?php __('Edit TrackingRelease');?></legend>
	<?php
		echo $form->input('tracking_release_id');
		echo $form->input('name');
		echo $form->input('description');
		echo $form->input('TrackingArea');
	?>
	</fieldset>
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('TrackingRelease.tracking_release_id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('TrackingRelease.tracking_release_id'))); ?></li>
