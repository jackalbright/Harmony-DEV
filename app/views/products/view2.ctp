...
<tr>
	...
	<? } else { ?>
	<td valign="top" rowspan="4" style="width: 225px;" align="center">
		<?= $hd->product_element("products/sample_gallery_tabbed",$product['Product']['prod'],array('products'=>$products,'size'=>'200')); ?>
	</td>
	<? } ?>
	...
	<td valign="top">
		...
		<tr>
			<td>&nbsp;</td>
			<td class="bold">
				<?= !empty($product['Product']['short_name']) ? $product['Product']['short_name'] : $product['Product']['name'] ?> Pricing (each)
			</td>
		</tr>
		<tr>
