<div style="width: 600px;">
	...
	<? list($w,$h) = $hd->getShrunkImageSize($build['CustomImage']['display_location'], 300,300); ?>
	...
	&nbsp;
		...
		<div class="left">
			<div class="relative">
			<img id="testImage_fullfit" class="" src="<?= $build['CustomImage']['display_location'] ?>?rand=<?=rand();?>" width="<?= $w ?>" height="<?= $h ?>"/>
			</div>
	...
	&nbsp;
		...
		<div valign="top" class="left">
			<div>
			<img id="testImage_bestfit" class="" src="<?= $build['CustomImage']['display_location'] ?>?rand=<?=rand();?>" width="<?= $w ?>" height="<?= $h ?>"/>
			</div>
