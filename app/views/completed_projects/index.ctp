<div class="completedImages index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('image_ext');?></th>
			<th><?php echo $this->Paginator->sort('image2_size');?></th>
			<th><?php echo $this->Paginator->sort('image2_file');?></th>
			<th><?php echo $this->Paginator->sort('image2_type');?></th>
			<th><?php echo $this->Paginator->sort('image2_ext');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $completedImage['CompletedImage']['full_name']; ?>&nbsp;</td>
		...
		<td><?php echo $completedImage['CompletedImage']['proof']; ?>&nbsp;</td>
		...
		<td><?php echo $completedImage['CompletedImage']['image_size']; ?>&nbsp;</td>
		<td><?php echo $completedImage['CompletedImage']['image_file']; ?>&nbsp;</td>
		<td><?php echo $completedImage['CompletedImage']['image_type']; ?>&nbsp;</td>
		<td><?php echo $completedImage['CompletedImage']['image_ext']; ?>&nbsp;</td>
		<td><?php echo $completedImage['CompletedImage']['image2_size']; ?>&nbsp;</td>
		<td><?php echo $completedImage['CompletedImage']['image2_file']; ?>&nbsp;</td>
		<td><?php echo $completedImage['CompletedImage']['image2_type']; ?>&nbsp;</td>
		<td><?php echo $completedImage['CompletedImage']['image2_ext']; ?>&nbsp;</td>
