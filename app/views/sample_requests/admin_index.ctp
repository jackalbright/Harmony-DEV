...
<div align="right">
	<?= $this->Form->create("SampleRequest", array('url'=>array('action'=>'search'))); ?>
		<?= $this->Form->input('id', array('type'=>'text','label'=>'Search By ID')); ?>
...
<tr>
	...
	<th><?php echo $paginator->sort('name','First Name');?></th>
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link('View', array('action' => 'view', $sampleRequest['SampleRequest']['id'])); ?> | 
