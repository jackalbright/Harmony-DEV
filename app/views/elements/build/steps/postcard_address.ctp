...
<!--						<p class="note">
		...
		<div id="addressField">
			<p>
				<textarea id="postcardAddressInput" name="postcardAddressInput" rows="3" cols="26" onkeyup="typingAddress(event);"><?php echo $currentItem->parts->postcardAddress; ?></textarea>
				<br />
				<span class="note">
