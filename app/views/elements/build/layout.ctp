...
<div style="padding: 10px;">
	...
	<? if(empty($product_config['image.2']) && empty($product_config_fullview['image.2'])) { ?>
		...
		<td valign="bottom" width="200" align="center">
			<?#=
				$this->element("build/preview", array('template'=>'imageonly_nopersonalization','no_view_larger'=>1,'fullbleed'=>0,'set_layout_link'=>1,'scale'=>'-115x115','rotate'=>$rotate)); 
	...
	<? } else { ?>
		<td valign="bottom" width="200" align="center">
			<?#= $this->element("build/preview", array('template'=>'imageonly_nopersonalization','noimage'=>0,'no_view_larger'=>1,'fullbleed'=>0,'set_layout_link'=>1,'rotate'=>$rotate,'scale'=>'-115x115')); ?>
		</td>
		<td valign="bottom" width="200" align="center">
			<?#= $this->element("build/preview", array('template'=>'standard','noimage'=>0,'no_view_larger'=>1,'fullbleed'=>0,'set_layout_link'=>1,'rotate'=>$rotate,'scale'=>'-115x115')); ?>
		</td>
	<? } ?>
	</tr>
	<tr>
