<div class="right hidden" align="right" > <a href="Javascript:void(0);" onClick="updateBuildImage();"><img src="/images/buttons/small/Preview.gif"/> </div>

<div class="clear">
		<select id="option_shirt_size" name="data[options][shirtSize]">
