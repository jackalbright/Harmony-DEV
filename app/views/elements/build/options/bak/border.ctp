...
<a rel="shadowbox;width=600;height=400" href="/build/option_select/<?= $build['Product']['code'] ?>/border">View All Borders</a>
</div>
...
<div class="clear">
		...
		<select id="option_border" name="data[options][borderID]" onChange="changeOptionPreview('border', this.value, border_images); updateBuildImage();">
