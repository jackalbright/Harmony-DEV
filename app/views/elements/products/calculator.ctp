...
<td width="50%" valign="top">
	...
	<div class="bold">Quantity (Min: <?= $product['Product']['minimum'] ?>)</div>
	<table border=1 id="pricing_calculator" width="300">
	<tr>
	...
	<tr>
		<td colspan=3 valign="top">
			...
			<div class="right">
				<input type="image" align="top" src="/images/webButtons2014/grey/large/calculate.png" onClick="showPleaseWait();"/>
			</div>
...
<td valign="top" style="border-left: solid #CCC 1px; padding: 5px;">
	...
	<form action="/gallery" target='_top'>
		...
		<? } else { ?>
			<input type="image" src="/images/webButtons2014/green/large/startDesigningMyOwn.png"/>
		<? } ?>
	</form>
