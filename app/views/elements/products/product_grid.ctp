...
echo __line__ ." product_grid.ctp <strong>items_per_row : </strong>" . $items_per_row. "<br>";
...
<?php echo __line__ . "product_grid.ctp <br>";?>
<div class="clear"></div>

<?php //$items_per_row = -1; // testing ?>
<div class="rounded product_table" >
<? if($items_per_row == -1) { ?> 
...
<? } ?>
<!-- L A Y O U T     T H E       P R O D U C T       B O X E S-->
<div class='container' style="border:1px solid #900">
...
</div> <!-- main product grid container div-->
	<? if(isset($link_href)) { ?>
