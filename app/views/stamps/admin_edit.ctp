		...
		<tr>
			<td>
				...
				<? if(!empty($this->data['Stamp']['image_location'])) { ?>
					<img style="background-color: black; border: solid black 5px !important; max-width: 300px; max-height: 300px;" src="<?= $this->data['Stamp']['image_location']; ?>"/>
				<? } ?>
			...
			<td width="400">
				...
				<div id="surcharge" style="<?= !empty($surcharge) ? "" : "display: none;" ?>">
					...
					<?= $form->input('StampSurcharge.surcharge',array('class'=>'StampSurcharge')); ?>
					<?= $form->input('StampSurcharge.per1',array('class'=>'StampSurcharge')); ?>
					<?= $form->input('StampSurcharge.per12',array('class'=>'StampSurcharge')); ?>
					<?= $form->input('StampSurcharge.per50',array('class'=>'StampSurcharge')); ?>
					<?= $form->input('StampSurcharge.per100',array('class'=>'StampSurcharge')); ?>
					<?= $form->input('StampSurcharge.per250',array('class'=>'StampSurcharge')); ?>
					<?= $form->input('StampSurcharge.per500',array('class'=>'StampSurcharge')); ?>
					<?= $form->input('StampSurcharge.per1000',array('class'=>'StampSurcharge')); ?>
					<?= $form->input('StampSurcharge.per2500',array('class'=>'StampSurcharge')); ?>
					<?= $form->input('StampSurcharge.per5000',array('class'=>'StampSurcharge')); ?>
					<?= $form->input('StampSurcharge.per7500',array('class'=>'StampSurcharge')); ?>
				</div>
