...
?>
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $staticPage['StaticPage']['path']; ?>
		</td>
		<td>
		...
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action'=>'view', $staticPage['StaticPage']['static_page_id'])); ?>
			<?php echo $html->link(__('Edit', true), array('action'=>'edit', $staticPage['StaticPage']['static_page_id'])); ?>
			<?php echo $html->link(__('Delete', true), array('action'=>'delete', $staticPage['StaticPage']['static_page_id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $staticPage['StaticPage']['static_page_id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
