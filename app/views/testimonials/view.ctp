...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit Testimonial', true), array('action'=>'edit', $testimonial['Testimonial']['testimonial_id'])); ?> </li>
		<li><?php echo $html->link(__('Delete Testimonial', true), array('action'=>'delete', $testimonial['Testimonial']['testimonial_id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $testimonial['Testimonial']['testimonial_id'])); ?> </li>
