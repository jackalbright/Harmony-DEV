...
<?php echo $form->create('WorkRequest');?>
	<fieldset>
 		<legend><?php __('Edit WorkRequest');?></legend>
	<?php
		echo $form->input('work_request_id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('WorkRequest.work_request_id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('WorkRequest.work_request_id'))); ?></li>
