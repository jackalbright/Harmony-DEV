...
<?php echo $form->create('TrackingEntry');?>
	<fieldset>
 		<legend><?php __('Edit TrackingEntry');?></legend>
	<?php
		echo $form->input('tracking_entry_id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('TrackingEntry.tracking_entry_id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('TrackingEntry.tracking_entry_id'))); ?></li>
