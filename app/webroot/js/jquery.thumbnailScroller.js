...
(function($){  
 $.fn.thumbnailScroller=function(options){  
    ...
    return this.each(function(){ 
		...
		//console.log(options.scrollerType);
		//do the scrolling
		//console.log("SCROLL="+totalWidth+", "+$this.width() + ", "+totalHeight+" > "+$this.height());
