...
(function() {
	...
	tinymce.create('tinymce.themes.AdvancedTheme', {
		...
		stateControls : ['forecolor', 'forecolorpicker', 'bold', 'italic', 'underline', 'strikethrough', 'bullist', 'numlist', 'justifyleft', 'justifycenter', 'justifyright', 'justifyfull', 'sub', 'sup', 'blockquote'],
