...
(function() {
	...
	tinymce.create('tinymce.themes.AdvancedTheme', {
		...
		stateControls : ['forecolorpicker', 'bold', 'italic', 'underline', 'strikethrough', 'bullist', 'numlist', 'justifyleft', 'justifycenter', 'justifyright', 'justifyfull', 'sub', 'sup', 'blockquote'],
		...
		init : function(ed, url) {
			...
			t.settings = s = extend({
				...
				*/
				theme_advanced_buttons1 : "formatselect,bold,italic,underline,strikethrough,sup,sub,removeformat",
				theme_advanced_buttons2 : "forecolor,bullist,numlist,link,unlink,anchor,image,sup,sub,charmap,code,hr",
