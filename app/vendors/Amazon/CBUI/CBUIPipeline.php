...
abstract class Amazon_FPS_CBUIPipeline {
    ...
    protected static $SANDBOX_CBUI_URL = "https://authorize.payments-sandbox.amazon.com/cobranded-ui/actions/start";
    ...
    private function constructUrl($parameters) {
        ...
        $hostHeader = $this->getHostHeader(defined("AWS_SANDBOX") ? self::$SANDBOX_CBUI_URL : self::$CBUI_URL);
        $requestURI = $this->getRequestURI(defined("AWS_SANDBOX") ? self::$SANDBOX_CBUI_URL : self::$CBUI_URL);
        ...
        return (defined("AWS_SANDBOX") ? self::$SANDBOX_CBUI_URL : self::$CBUI_URL) . "?" . $queryString;
    }
