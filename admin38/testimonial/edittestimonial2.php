...
$txtTestimonialText=$_POST['txtTestimonialText'];
$txtAttribution=$_POST['txtAttribution'];
 ?>
<?php
	include ('../../includes/database.inc');
    $txtQueryString = "UPDATE testimonial SET text='$txtTestimonialText', attribution='$txtAttribution' WHERE testimonial_id='$txtTestimonialID'";
		...
		<table width="700" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td>
					...
					entered into the database about this particular testimonial.
</p>
