 ...
 */
// if ( strpos($_SERVER['SERVER_NAME'], 'harmonydesigns' ) !== False ) {
	$cfg['PmaAbsoluteUri'] = 'https://www.harmonydesigns.com/admin38/phpMyAdmin/';
//} else {
//	$cfg['PmaAbsoluteUri'] = 'http://www.hdtest.com/admin38/phpMyAdmin/';
//}
...
//if ( strpos($_SERVER['SERVER_NAME'], 'harmonydesigns' ) !== False ) {
	$cfg['Servers'][$i]['user']          = 'harmony_admin';      // MySQL user
	$cfg['Servers'][$i]['password']      = 'tempo456';          // MySQL password (only needed with 'config' auth_type)
//} else {
//	$cfg['Servers'][$i]['user']          = 'hdtest';      // MySQL user
//	$cfg['Servers'][$i]['password']      = 'melody789';          // MySQL password (only needed with 'config' auth_type)
//}
