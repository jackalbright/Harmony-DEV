...
?>
<?php
	if (array_key_exists('txtDirection', $_POST)){ 
		...
		$cbQuoteSubjects=$_POST['cbQuoteSubjects'];
	} else {
		$txtDirection="";
		$txtSearchPhrase="";
		$cbTitle="";
	...
	if ($cbQuoteSubjects=="True" && $txtSearchPhrase!=""){
			for ($i=0; $i < $numTerms; $i++){
				include ('../../includes/database.inc');
...
<script language="javascript1.2" type="text/javascript">
	function clearform(){
		document.frmQuote.action="deletequote.php";
	...
	<body bgcolor="#ffffff">
		<table width="700" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td>
					<div align="center">
						<form action="searchquotec.php" method="post" name="frmQuote">
							<table width="450" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
								  ...
								  <td><p>
							        ...
							        in Attribution<br>
							        <input type="checkbox" name="cbQuoteSubjects" value="True" checked>
							        in Subjects</span><br>
					              </p>							      </td>
							  </tr>
							   <tr>
								...
								<tr>
									...
									<td><p><span class="basetext"><b>Title:  <?php echo $txtQuoteTitle[$i]; ?></b></span><br>
							            ...
							            <span class="basetext"><i>Subjects: <?php echo $txtQuoteSubjects[$i]; ?></i></span><br>
									  <span class="basetext">Stamps Using Quote:</span>
								<?php
									include ('../../includes/database.inc');
								    $result = mysql_query ("SELECT catalog_number FROM rec_quote WHERE quote_id='$txtQuoteID[$i]'", $database);
								    if (mysql_num_rows($result)){
	    							while ($quote = mysql_fetch_object($result)){
										echo("<a href=\"../../product/detail.php?catalogNumber=$quote->catalog_number\">$quote->catalog_number</a> ");
									};}
									else {echo " None";}
								     mysql_close($database);
								?>								  
