...
<script language="javascript1.2" type="text/javascript">
	function clearform(){
		var tester = true;
		tester = confirm("Are you absolutely certain you wish to delete the selected quote(s)?");
		if (tester){
	...
	<body bgcolor="#ffffff">
		<table width="700" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td>
					<div align="center">
						<form action="searchquoteb.php" method="post" name="frmQuote">
							<table width="450" border="0" cellspacing="0" cellpadding="0">
							   ...
							   <tr>
								...
								for ($i=0; $i<=$numQuotes; $i++){?>
								<tr>
									<td><input class="txtRecQuote" type="checkbox" name="cbQuote[]" value="<?php echo $txtQuoteID[$i]; ?>"></td>
