...
if ($_POST['cbSurcharge'] == 'True')
 ...
 $txtRecTassel=join(", ",$txtTassels);
	$txtSearchPhrase=htmlentities($_POST['txtSearchPhrase']);
	...
	<head>
		...
		<script language="javascript1.2" type="text/javascript">
			function clearform(){
				...
				document.frmQuote.action="addstamp3.php";
		...
		<table width="700" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td width="200" valign="top" class="title style3"><p>Navigation:</p>
			      ...
			      <p class="basetext"><a href="addquote.php" target="_blank">Add Quote</a> </p></td>
				<td>
					<div align="center">
						<form action="addstamp2a.php" method="post" name="frmQuote"><input type="hidden" name="txtCatalogNumber" value="<?php echo $txtCatalogNumber; ?>">
