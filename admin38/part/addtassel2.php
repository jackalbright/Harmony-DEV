...
<?php
    ...
    $txtQueryString = "INSERT tassel (tassel_id, color_name, color_code, available) VALUES ('', '$txtTasselName', '$txtColorCode', '$txtAvailable')";
			...
			<tr>
				...
				<td>
					...
					entered into the database about this particular tassel.
					  ...
					  <p><span class="basetext"><b>To enter a new tassel or to edit a tassel, click <a href="tasselsmenu.php">here</a>.</b></span></p>
