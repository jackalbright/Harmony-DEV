...
$txtSubjects=addslashes($_POST['txtQuoteSubjects']);
$intTextLength=strlen($txtQuoteBody);
...
<?php
    ...
    $txtQueryString = "UPDATE quote SET quote_id='$cbQuote', text='$txtQuoteBody', title='$txtQuoteTitle', attribution='$txtAttribution', subjects='$txtSubjects' WHERE quote_id='$cbQuote'";
...
--></style>
	...
	<body bgcolor="#ffffff">
		<table width="700" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td>
					<div align="center">					  
					  <p align="left" class="basetext">
					 This quote has been edited and updated in the database. (Note: Do not be alarmed by slashes that appear on this page. They are there only to enter the information into the database cleanly. They will not appear on the final page.) </p>
					  <blockquote><p align="left" class="basetext"><strong>Title: <?php echo $txtQuoteTitle; ?></strong><br>
  Body: 
      <?php 
						if ($txtAddMarks=="yes"){
							echo "&quot;";
  ...
  <em>Subjects: <?php echo $txtSubjects; ?></em>  </p>
					  </blockquote>
					  <p class="basetext"><br>
                        <span class="basetext"><b>To enter a new quote or to edit a quote, click <a href="quotesmenu.php">here</a>.</b></span></p>
