...
<?php
    ...
    $txtQueryString = "INSERT charm (charm_id, name, graphic_location, available) VALUES ('', '$txtCharmName', '$txtThumbnailLocation', '$txtAvailable')";
...
--></style>
	...
	<body bgcolor="#ffffff">
		<table width="700" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td width="200" valign="top"><p><p class="title style1">Navigation:</p>
