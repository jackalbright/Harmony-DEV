...
$txtTasselName=$_POST['txtTasselName'];
...
<?php
    ...
    $txtQueryString = "UPDATE tassel SET color_name='$txtTasselName', color_code='$txtColorCode', available='$txtAvailable' WHERE tassel_id='$txtTasselID'";
		...
		<table width="700" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td>
					...
					entered into the database about this particular tassel.
</p>
					  <p class="basetext"><?php echo $txtQueryString;  ?></p>
					  <p><span class="basetext"><b>To enter a new charm or to edit a tassel, click <a href="tasselsmenu.php">here</a>.</b></span></p>
