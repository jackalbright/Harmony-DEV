...
$txtCharmName=$_POST['txtCharmName'];
$txtThumbnailLocation=$_POST['txtThumbnailLocation'];

$charmCode = preg_replace("/\/charms\/(.*)[.]\w+$/", '$1', $txtThumbnailLocation);
...
$txtPopular = !empty($_POST['cbPopular']) ? $_POST['cbPopular'] : 0;
 ?>
<?php
	include ('../../includes/database.inc');
    $txtQueryString = "UPDATE charm SET name='$txtCharmName', charm_code = '$charmCode', graphic_location='$txtThumbnailLocation', available='$txtAvailable', popular ='$txtPopular' WHERE charm_id='$txtCharmID'";
		...
		<table width="700" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td>
					...
					entered into the database about this particular charm.
</p>
					  <p class="basetext"><?php echo $txtQueryString;  ?></p>
					  <p><span class="basetext"><b>To enter a new charm or to edit a charm, click <a href="charmsmenu.php">here</a>.</b></span></p>
