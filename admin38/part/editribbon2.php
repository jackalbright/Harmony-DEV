...
$txtRibbonName=$_POST['txtRibbonName'];
...
<?php
    ...
    $txtQueryString = "UPDATE ribbon SET color_name='$txtRibbonName', color_code='$txtColorCode', available='$txtAvailable' WHERE ribbon_id='$txtRibbonID'";
		...
		<table width="700" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td>
					...
					entered into the database about this particular ribbon.
</p>
					  <p class="basetext"><?php echo $txtQueryString;  ?></p>
					  <p><span class="basetext"><b>To enter a new charm or to edit a ribbon, click <a href="ribbonsmenu.php">here</a>.</b></span></p>
