...
<?php
    ...
    $txtQueryString = "INSERT ribbon (ribbon_id, color_name, color_code, available) VALUES ('', '$txtRibbonName', '$txtColorCode', '$txtAvailable')";
			...
			<tr>
				...
				<td>
					...
					entered into the database about this particular ribbon.
					  ...
					  <p><span class="basetext"><b>To enter a new ribbon or to edit a ribbon, click <a href="ribbonsmenu.php">here</a>.</b></span></p>
